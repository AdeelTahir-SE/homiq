...
export default function AgentSidebar({
  ...
  return (
    <aside
      className={`w-60 flex-shrink-0 bg-[#F9F6F4] border-r border-[#ece5de] h-screen sticky top-0 flex flex-col justify-between p-4 sm:p-5 select-none overflow-y-auto ${className}`}
    >
      ...
      <div className="space-y-6">
        ...
        <Link href="/dashboard" className="flex items-center gap-2.5 px-2 py-1 group">
          ...
          <span className="text-2xl sm:text-[26px] font-bold tracking-tight text-[#0D2449]">
            HOMIQ
          </span>
        </Link>

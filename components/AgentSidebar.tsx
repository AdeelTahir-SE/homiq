...
export default function AgentSidebar({
  ...
  return (
    <aside
      className={`w-60 flex-shrink-0 bg-[#F9F6F4] border-r border-[#ece5de] h-screen sticky top-0 flex flex-col justify-between p-4 sm:p-5 select-none overflow-y-auto no-scrollbar ${className}`}
    >
      {/* Upper Section: Brand + Navigation List */}
      ...
      {/* Lower Section: HOMIQ Pro Card (Complete Golden Crown & Golden Border) */}
      <div className="mt-6 pt-2">
        <div className="bg-white/80 border border-[#d99738] rounded-md p-4 text-left relative overflow-hidden shadow-2xs">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-sm font-bold text-[#0D2449]">HOMIQ Pro</h4>
          </div>
          ...
          <button
            ...
            className="mt-3.5 w-full bg-white hover:bg-[#fefaf4] border border-[#d99738] text-[#d99738] text-xs font-bold py-2 px-3.5 rounded-md shadow-2xs transition duration-150 cursor-pointer text-center"
          >
            Upgrade Now
          </button>
        </div>

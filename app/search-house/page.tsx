        ...
        <main className="flex-1 flex flex-col overflow-hidden min-w-0 bg-white relative">
          ...
          <div className="px-4 sm:px-6 py-3.5 sm:py-4 flex-shrink-0 bg-white border-b border-slate-100 lg:border-none">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              {/* Controls: Sort Dropdown (Right-of-Center) & Right Actions (Filters, Save Search) */}
              <div className="flex items-center gap-3 sm:gap-6 md:gap-8 lg:gap-14 flex-wrap sm:flex-nowrap justify-between sm:justify-end">
                {/* Sort Dropdown: Right of Center */}
                <div className="relative">
                  <select className="text-xs font-semibold text-[#0C2346] bg-white border border-slate-200 rounded-lg py-2 sm:py-2.5 pl-3 sm:pl-4 pr-9 sm:pr-10 appearance-none outline-none cursor-pointer shadow-sm hover:border-slate-300">
                  ...
                  <svg
                    className="w-3.5 h-3.5 text-slate-500 absolute right-3 top-3 sm:top-3.5 pointer-events-none"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                {/* Right Actions: Mobile Filter & Save Search */}
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className="bg-[#0C2346] hover:bg-[#091b37] text-white text-xs font-semibold py-2.5 px-4 sm:px-5 rounded-lg flex items-center gap-2 shadow-sm transition duration-150 cursor-pointer flex-shrink-0"
                  >
                    <svg
